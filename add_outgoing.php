...
<head>
    ...
    <title>Tambah Surat Keluar - Kecamatan Masama</title>
        ...
        <main class="container mx-auto px-4 py-8">
            <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-6">
                <h2 class="text-2xl font-bold text-gray-800 mb-6">
                    ...
                    Tambah Surat Keluar - Kec. Masama
                </h2>
                ...
                <form action="server/save_outgoing.php" method="POST">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">Contoh: 005/SK/MASAMA/VI/2023</p>
                        </div>
                    ...
                    <div class="mb-6">
                        <label for="recipient" class="block text-sm font-medium text-gray-700 mb-1">Tujuan Surat*</label>
